...
namespace MementoMori\Helpers;

use MementoMori\Enums\Color;

/**
 * MementoMori Printer
 *
 * @package MementoMori\Utils
...
abstract class Printer
{
    ...
    {
        self::display(Color::GREEN . $message . "\e[0m");
    }
    ...
    {
        self::display(Color::YELLOW . $message . "\e[0m");
    }
    ...
    {
        self::display(Color::RED . $message . "\e[0m");
    }
}
